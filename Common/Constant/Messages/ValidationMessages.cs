namespace JobNexus.Common.Constant.Messages
{
    public static class ValidationMessages
    {
        ...
        public const string UsernameMaxLength = "Username can not exceed 50 characters";
        public const string EmailMaxLength = "Email can not exceed 50 characters";
        ...
        public const string SkillNameMaxLength = "Skill name can not exceed 50 characters";
        ...
        public const string JobLocationMaxLength = "Job location can not exceed 50 characters";
        public const string JobLevelMaxLength = "Job level can not exceed 50 characters";
